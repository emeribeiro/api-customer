...
import com.example.api.commons.Utils;
...
public class CustomerControllerTest {
	...
	public void testFindByIdBySucess() throws Exception {
		this.mvc.perform(get(URL_CUSTOMER_ONE))
			.andExpect(status().isOk())
			.andExpect(jsonPath("name", equalTo("Mariazinha")));
	...
	public void testCreateSuccess() throws Exception {
		Customer customer = Utils.createAndGetCustomerForm("Mariazinha", "mariazinha@email.com").converter();
	...
	public void testCreateBadRequest() throws Exception {
		Customer customer = Utils.createAndGetCustomerForm("Mariazinha", "").converter();
